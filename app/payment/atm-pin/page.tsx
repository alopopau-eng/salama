...
import { Menu, MessageCircle, Facebook, Twitter, Instagram } from "lucide-react"
    ...
    <div className="min-h-screen bg-stone-50 font-sans" dir="rtl" lang="ar">
      ...
      <header className="bg-white border-b border-stone-200 sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between max-w-7xl">
          <button onClick={() => router.push('/payment/otp')} className="p-2 hover:bg-stone-100 rounded-lg transition-colors">
